...
public class Capitulo7l {
  ...
  public static void main(String[]args) {
    ...
    double mediaDePontos = usuarios.stream().mapToInt(Usuario::getPontos).average().orElse(0.0);
    System.out.println("Média de pontos: " + mediaDePontos);
