...
public class Capitulo9f {
  ...
  public static void main(String[]args) {
      ...
      Map<Integer, List<Usuario>> integerListMap = new HashMap<>();

      for (Usuario usuario : usuarios) {

          if(!integerListMap.containsKey(usuario.getPontos())) {
              integerListMap.put(usuario.getPontos(), new ArrayList<>());
          }

          integerListMap.get(usuario.getPontos()).add(usuario);
